...
public class MostrarTareasResponse {
    ...
    protected List<MostrarTareasResponse.Tareas> tareas;
     ...
     * {@link MostrarTareasResponse.Tareas }
     * 
     * 
     */
    public List<MostrarTareasResponse.Tareas> getTareas() {
        if (tareas == null) {
            tareas = new ArrayList<MostrarTareasResponse.Tareas>();
        }
        return this.tareas;
    }
