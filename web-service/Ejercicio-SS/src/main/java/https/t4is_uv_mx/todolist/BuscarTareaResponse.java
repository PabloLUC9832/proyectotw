...
@XmlRootElement(name = "BuscarTareaResponse")
public class BuscarTareaResponse {

    @XmlElement(required = true)
    protected List<BuscarTareaResponse.Tareas> tareas;
     ...
     * {@link BuscarTareaResponse.Tareas }
     * 
     * 
     */
    public List<BuscarTareaResponse.Tareas> getTareas() {
        if (tareas == null) {
            tareas = new ArrayList<BuscarTareaResponse.Tareas>();
        }
        return this.tareas;
    }
