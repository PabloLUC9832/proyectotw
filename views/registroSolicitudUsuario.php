...
<h1 class="text-center">Registrar Solicitud de acceso al sistema</h1>

    <div class="container m-5">

 
        <form action="../controllers/registroSolicitudUsuario.php" method="POST">
        ...
        <p class="mt-5">Ya tienes cuenta. <span><a href="../views/inicio_de_sesion.php"><b>Inicia Sesión aquí</b></a></span> </p>
