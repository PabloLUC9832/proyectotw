...
<!--                 <div class="form-group row">
                    <label for="observacion" class="col-sm-2 col-form-label col-form-label-sm">Observación</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-sm" id="observacion" placeholder="Observación" required name="observacion">
                    </div>
                </div> -->
